...
---
```
*Note: Make sure your `hugo.toml` has `JSON` output enabled for the home page so the search engine can index your articles.*
...
```
*Note: Any text you place below the front matter dashes will automatically be used as the Hero subtitle.*
